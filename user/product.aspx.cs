...
public partial class user_product : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            Panel1.Controls.Add(new LiteralControl("<a href=productview.aspx?id=" + dt.Rows[i][0].ToString() + ">"));
            Panel1.Controls.Add(img);
            Panel1.Controls.Add(new LiteralControl("</a>"));
            Panel1.Controls.Add(new LiteralControl("</td></tr>"));
            Panel1.Controls.Add(new LiteralControl("<tr><td align='center'>" + dt.Rows[i][1].ToString()+",  MRP : ₹"+dt.Rows[i][4]));
            Panel1.Controls.Add(new LiteralControl("</td></tr>"));
